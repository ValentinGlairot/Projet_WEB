<section class="content">
    ...
    <p>Les présentes Conditions Générales d’Utilisation définissent les règles d’accès et d’utilisation du site CESI Ta
        Chance.</p>
    ...
    <p>Pour accéder à certaines fonctionnalités (candidatures, gestion de wishlist), l’utilisateur doit créer un compte
        en fournissant des informations exactes.</p>
