<section class="content">
    ...
    <?php endif; ?>
    <form id="register-form" action="<?= BASE_URL ?>utilisateurs/inscription.php" method="POST">
    ...
    <div class="account-link">
        ...
        <a href="<?= BASE_URL ?>utilisateurs/connexion.php" class="btn-login">Se connecter</a>
    </div>
</section>
