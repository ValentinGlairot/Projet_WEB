...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <!-- Wishlist : désormais visible pour Admin ou Etudiant -->
            <?php if (
                isset($_SESSION['user']) && (
        ...
        <div id="user-menu">
            ...
            <?php else: ?>
                ...
                <a href="<?= BASE_URL ?>index.php?controller=utilisateur&action=connexion" id="login-btn"
                    class="btn-login">Connexion</a>
            <?php endif; ?>
        </div>
