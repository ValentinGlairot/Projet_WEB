...
<section class="content">
    ...
    <!-- Formulaire de candidature (postuler) pour étudiants -->
    <?php if ($userRole === 'Étudiant'): ?>
        <h3>Postuler à cette offre</h3>
        <form action="<?= BASE_URL ?>index.php?controller=candidature&action=postuler" method="post"
    ...
    <div class="back-button-container">
        <a href="<?= BASE_URL ?>index.php?controller=offre&action=detail&id=<?= $offre['id'] ?>" class="btn btn-back">⬅
            Retour aux offres</a>
    </div>
</section>